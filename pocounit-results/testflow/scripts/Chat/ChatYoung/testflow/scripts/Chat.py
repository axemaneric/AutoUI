...
class ChatYoung(ChatCase):
    ...
    def runTest(self):
        ...
        self.assertTrue(exists(Template(self.R('res/img/Commons.png'))), "Not in Commons after age verification (young)")
...
class EmojiChat(ChatCase):
    ...
    def runTest(self):
        self.poco("of_age").click()
        self.poco("continue").click()
        self.assertTrue(exists(Template(self.R('res/img/chat/chat.png'))), "Chat screen not found")
        ...
        self.assertTrue(exists(Template(self.R('res/img/chat/emoji_chat.png'))), "Chat with emoji not found on screen")
